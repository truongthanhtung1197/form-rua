  ...
  return (
    <div className="not-italic">
      ...
      <article className="bg-grayf0 px-5 ">
        <h1 className="text-[24px] leading-[32px] font-bold py-[19px]">
          NHỮNG BÀI HỌC SÂU SẮC CẦN KHẮC CỐT GHI TÂM
        </h1>
        <p className="opacity-50 text-[18px] leading-[21px]">05/08/2019</p>
        ...
        <p className=" ml-[595px] text-[16px] leading-[19px] font-normal py-[25px]">
          DƯƠNG XUÂN PHI
        </p>
      </article>
    </div>
